...
* I started specing out via test cases concerns around managing stream processing through disconnects, back off periods etc as the twitter documentation described, but I did not get that far in my time boxed efforts. Right now I’m not handling stream pauses or disconnects at all.
